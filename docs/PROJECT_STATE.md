...
## Next (in order)
1. ✅ ~~First-run hint UI + signing~~ — done 2026-06-13. Hint card + `Debug.local.xcconfig` signing built & probe-verified. **Remaining:** user on-screen visual + refine `FirstRunHintView.cardBody` copy (left as a clean default). App icon ✅ done.
