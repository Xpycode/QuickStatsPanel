...
| Power (watts) | `IOReport` (permission-free; `powermetrics` needs root) — **D-019, needs spec** | v2 next |
| Temperatures | IOHID per-sensor °C + `ProcessInfo.thermalState` tile | v2 (D-018) |
